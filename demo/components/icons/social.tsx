...
/** Single-path glyphs sized to sit on the 18px social row. */
const glyph = (props: P) => ({
  width: 18,
  height: 18,
  viewBox: "0 0 24 24",
...
export const DiscordLogo = (props: P) => (
  <svg {...glyph(props)}>
...
export const FarcasterLogo = (props: P) => (
  <svg {...glyph(props)}>
...
export const LinkedinLogo = (props: P) => (
  <svg {...glyph(props)}>
...
export const GlobeLogo = (props: P) => (
  <svg {...glyph({ fill: "none", stroke: "currentColor", strokeWidth: 1.8, ...props })}>
